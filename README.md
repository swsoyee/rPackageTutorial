...
8.  [R
    包开发](https://rstudio-pubs-static.s3.amazonaws.com/462425_841be258782641ee83e8b89c45fa504c.html)
...
动机其实也很简单，可能也是由于自己阅读或者搜索深度不够，目前还没有发现一篇说到如何用“专业”的方式来创建
R 包的教程。
...
很好，直接返回 GitHub Desktop 保存提交。 嗯？是否无法提交了？弹出错误提示：
...
除了以上列举的步骤外，其实还有很多能用的东西，但如果写起来真是没完没了。 如果感兴趣的话可以去查看 **Hadley Wickham** 编写的
[R Packages](https://r-pkgs.org/)了解更多详细内容和具体的说明。
