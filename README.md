...
You can install the released version of rPackageTutorial from
...
devtools::install_github("swsoyee/rPackageTutorial")
```
...
Please note that the rPackageTutorial project is released with a
[Contributor Code of
